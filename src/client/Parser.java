...
public class Parser {
	...
	public void turnSet(String input) {
		String[] playerState = input.split(";");
		String[] dealer = playerState[1].split("~");
		...
		User.dealersCards.add(Integer.parseInt(dealer[1]));
		p1.cards.addLast(Integer.parseInt(p1State[2]));
		p2.cards.addLast(Integer.parseInt(p2State[2]));
